...
function Badge({ className, variant, key, ...props }: React.HTMLAttributes<HTMLDivElement> & VariantProps<typeof badgeVariants> & { key?: React.Key }) { return <div className={cn(badgeVariants({ variant }), className)} {...props} /> }
